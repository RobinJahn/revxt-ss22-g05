...
\begin{table}[h]
\centering
	\begin{tabular} {| m{1.7cm} | m{3.1cm} | m{3.1cm} | m{3.1cm} | m{3.1cm}|}
		\hline
		\textbf{} &\textbf{Simon Melcher} & \textbf{Robin Jahn} & \textbf{Alexander Wess} & \textbf{als Gruppe}\\
		\hline
		Woche 1 & Erstellen von eigenen Spielfeldern & Erstellen von eigenen Spielfeldern; Implementierung der Datenstruktur, Einlesen und Ausgabe & Erstellen von eigenen Spielfeldern & Besprechung der Spielspezifikationen und Datenstruktur\\
		\hline
		Woche 2 & Programmierung der gültigen Züge für Spezialfelder & Programmierung der gültigen Züge & Beschreibung der Zugheuristiken im Projektbericht & Diskussion der Zugheuristiken\\
		\hline
		Woche 3 & Umsetzung der verbesserte Heuristik & Umsetzung der verbesserte Heuristik & Projektbericht Kapitel 1 - 3 & Verbesserung der Heuristik\\
		\hline
		...
		\hline
		Woche 8 & Programmierung einer neuer Funktion für die Bombenphase zum zählen der Steine & Änderung des Skripts zur Ermittlung der besten Multiplikatoren für die Heuristik & Implementierung einer neuen Funktion zur Bewertung von Bonusfeldern & Bearbeitung der ToDos\\
		\hline
